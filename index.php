...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-md-6">
          <a class="btn btn-default btn-primary btn-block" href="<?php echo URL_PREFIX; ?>/voluntario/cadastrar.php" role="button">Cadastrar &raquo;</a>
        </div>
        <div class="col-md-6">
          <a class="btn btn-default btn-success btn-block" href="<?php echo URL_PREFIX; ?>/voluntario/visualizar.php" role="button">Visualizar &raquo;</a>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-md-6">
          <a class="btn btn-default btn-primary btn-block" href="<?php echo URL_PREFIX; ?>/atividade/cadastrar.php" role="button">Cadastrar &raquo;</a>
        </div>
        <div class="col-md-6">
          <a class="btn btn-default btn-success btn-block" href="<?php echo URL_PREFIX; ?>/atividade/visualizar.php" role="button">Visualizar &raquo;</a>
        </div>
      </div>
   </div>
    <div class="col-md-4">
      ...
      <p><a class="btn btn-default btn-warning btn-block" href="<?php echo URL_PREFIX; ?>/estatisticas.php" role="button">Acessar &raquo;</a></p>
    </div>
  </div>
